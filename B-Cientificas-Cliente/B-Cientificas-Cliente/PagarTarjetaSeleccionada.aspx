...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <asp:TextBox ID="txtNumeroTarjeta" runat="server" class="form-control" MaxLength="16" TextMode="Number" AutoPostBack="True" ReadOnly="True"></asp:TextBox>
                                    </div>
                                </div>
                            </td>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <asp:Button ID="btnDescargar" class="btn btn-primary" runat="server" Text="Descargar" />
            </div>
        </div>
